<h2>unknown-problem</h2><h3>Medium</h3><hr><div><p>You are given an immutable linked list, print out all values of each node in reverse with the help of the following&nbsp;interface:</p>
